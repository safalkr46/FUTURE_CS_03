...
**Mapped Finding:** Sequential User ID Enumeration
...
**Mapped Finding:** Unauthenticated API Access
...
**Mapped Finding:** Excessive Data Exposure
...
**Mapped Finding:** Rate Limiting Controls
...
**Mapped Finding:** Security Header Configuration
